...
const char* ssid = "Acumalakaaa";
const char* password = "apaapaapa";
...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    HTTPClient http;
    String url = "http://7dfb-112-215-241-158.ngrok-free.app/api/posts"; // Ganti dengan URL ngrok yang benar
